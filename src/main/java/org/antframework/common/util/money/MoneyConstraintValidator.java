...
public class MoneyConstraintValidator implements ConstraintValidator<MoneyConstraint, Money> {
    // 违反最小值的信息模板
    private static final String VIOLATE_MIN_MESSAGE_TEMPLATE = "{org.antframework.common.util.money.MoneyConstraint.message.min}";
    // 违反最大值的信息模板
    private static final String VIOLATE_MAX_MESSAGE_TEMPLATE = "{org.antframework.common.util.money.MoneyConstraint.message.max}";
    // 违反不能为null的信息模板
    private static final String VIOLATE_NOT_NULL_MESSAGE_TEMPLATE = "{org.antframework.common.util.money.MoneyConstraint.message.not-null}";
